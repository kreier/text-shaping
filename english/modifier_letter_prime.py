...
fontname = ["aptos.ttf", "Khmer-Regular.ttf", "Roboto-Regular.ttf"]
teststrings = ["Me·thuʹse·lah", "Ma·halʹa·lel", "Laʹmech", "Eʹnosh"]
...
for typeface in fontname:
    ...
    pdf.set_text_shaping(use_shaping_engine=True, script="latn", language="eng")
    render_strings(teststrings)
